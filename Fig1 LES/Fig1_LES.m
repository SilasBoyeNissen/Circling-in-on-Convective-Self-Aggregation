tic;
figure(1); clf;
set(figure(1), 'Color', 'w', 'Position', [0 0 900 900]);

NC1 = ncread('full_evap_300K_200m_Aug30.out.vol.q.LEV50.nc', 'q');
NC2 = ncread('rem06Evap.out.vol.q.LEV50.nc', 'q');
NC3 = ncread('rem02Evap.out.vol.q.LEV50.nc', 'q');
NC4 = ncread('rem01Evap.out.vol.q.LEV50.nc', 'q');
NC5 = ncread('removeEvap.out.vol.q.LEV50.nc', 'q');
...
NoCol = 6;
figure(1); clf; tic;
set(figure(1), 'Color', 'w', 'Position', [0 0 1137 940]);
fig = tightsubplot(5, NoCol, [-0.008 -0.01], [-0.005 0], [0.005 0]);
mapVec = {'gray'};
